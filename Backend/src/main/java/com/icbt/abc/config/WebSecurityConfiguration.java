...
import com.icbt.abc.filters.JwtFilter;
import com.icbt.abc.service.UserService;
import com.icbt.abc.utility.constant.SecurityConfigurationProperties;
...
public class WebSecurityConfiguration {
    ...
    private static final String[] AUTH_WHITELIST = {"/api/v1/login","/api/v1/register/activate/{activationCode}","/api/v1/admin/{id}","/api/v1/register/**"};
    @Autowired
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/v1/user").hasAnyRole("PATIENT", "ADMIN")
