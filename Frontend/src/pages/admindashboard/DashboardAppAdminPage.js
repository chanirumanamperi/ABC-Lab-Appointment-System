    ...
    const fetchData = async () => {
      try {
        ...
        const customerCountResponse = await axios.get(
          "http://localhost:8080/ABC/api/v1/register/count",
          config1
        );
        ...
        const TechiciansCountResponse = await axios.get(
          "http://localhost:8080/ABC/api/v1/register/count",
          config3
        );
        setSoldAdsCount(TechiciansCountResponse.data.data || "0");
      } catch (error) {
